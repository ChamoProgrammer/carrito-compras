...
<?php
session_start();
$connect = mysqli_connect("localhost", "root", "", "carrito_compras");
...
// 'item_comentario' => $_POST["hidden_comentario"],
...
echo '<script>window.location="indice.php.php"</script>';
}
}
}
}
...
<!-- <h4 class="text-danger text-center">comentario <?php echo $row["comentario"]; ?></h4> -->
...
<!-- <input type="hidden" name="hidden_comentario" value="<?php echo $row["comentario"]; ?>" /> -->
</div>
</div>
</form>
</div>
...
<!-- <th width="20%" class='text-right'>comentarios</th> -->
...
<td><a href="indice.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Eliminar</span></a></td>
</tr>
<?php
